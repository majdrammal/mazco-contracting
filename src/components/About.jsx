    ...
    return (
        <div id="about">
            <div className="container">
                <p>Est. 2022</p>
                <h2>About Us</h2>
                <h3>With an extensive experience and a long and proven track record in the gulf market, <span style={{color: "rgb(172, 41, 41)", fontWeight: "bold"}}>Solid Contracting</span> has gradually grown to partner with it's clients by providing them with a wide range of construction material and delivering them to their sites.</h3>
